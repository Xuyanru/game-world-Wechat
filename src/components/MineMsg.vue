		...
		<div id="MineMsg-con">
			...
			<ul>
				...
				<li class="clear fk-phone">
					...
					<input class="lf" v-model="theData.phone" type="text" placeholder="请输入电话号码" name="" id="" value="" />
				</li>
				<li class="clear fk-bfr">
					<p class="lf fk-bfr icon">QQ</p>
					<input class="lf" v-model="theData.qq" type="text" placeholder="请输入QQ号" name="" id="" value="" />
				</li>
				<li class="clear fk-bfr">
					<p class="lf fk-wechat icon">微信</p>
					<input class="lf" v-model="theData.wechat" type="text" placeholder="请输入微信号" name="" id="" value="" />
				</li>
				<li class="clear fk-idcard">
					<p class="lf fk-idcard icon">角色名字</p>
					<input class="lf" v-model="theData.pid" type="text" placeholder="请输入角色名称" name="" id="" value="" />
				</li>
				<li class="clear fk-timec">
					<p class="lf fk-timec icon">在线时间</p>
					<input class="lf" v-model="theData.onlinetime" type="text" placeholder="请输入在线时间" name="" id="" value="" />
				</li>
				<li class="clear">
					<p class="lf fk-why icon">个性签名</p>
					<textarea v-model="theData.motto" name="" rows="5" cols="" placeholder="请输入个性签名(50字符内)" maxlength="50" onchange="this.value=this.value.substring(0, 50)"></textarea>
				...
				this.$ajax.post("user/perfect", this.theData, {
					...
					.then((data) => {
						...
						if(data.code == 1000) {
							...
							me.$parent.layerTimeout(data.msg, callBack);
						} else {
