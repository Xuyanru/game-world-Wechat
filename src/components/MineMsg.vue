...
<script>
	...
	export default {
		...
		methods: {
			//初始化
			init: function() {
				var basicMsg = this.$parent.vBasicMsg ? this.$parent.vBasicMsg : JSON.parse(sessionStorage.getItem("vBasicMsg"));
				this.theData = {
